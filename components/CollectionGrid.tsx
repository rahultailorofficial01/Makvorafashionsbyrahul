...
export const COLLECTION_ITEMS: ProductItem[] = [
  {
    id: "MKV-001",
    title: "Obsidian Bespoke Tuxedo Jacket",
    category: "Bespoke Tailoring",
    priceEUR: 8400,
    priceUSD: 9100,
    priceINR: 750000,
    tag: "Atelier Paris Hand-Stitching",
    image: "/look_bespoke_blazer.png",
    description: "Sculpted midnight velvet double-breasted tuxedo with hand-spun 24k gold thread pinstripes and raw silk lapel lining.",
    fabrics: ["100% Super 180s Wool", "24k Gold Metallic Weave", "Mulberry Silk"],
  ...
  {
    id: "MKV-004",
    title: "Imperial Vicuña Cashmere Overcoat",
    category: "Rare Outerwear",
    priceEUR: 22500,
    priceUSD: 24500,
    priceINR: 2000000,
    tag: "Limited Harvest (8 Made)",
    image: "/look_overcoat.png",
    description: "Crafted from wild Peruvian Vicuña wool—the rarest fiber in the world—lined with hand-printed Italian silk satin.",
    fabrics: ["100% Wild Peruvian Vicuña", "Como Silk Satin"],
    atelierTime: "95 Hours Tailoring",
  },
  {
    id: "MKV-005",
    ...
    description: "Precision-cut Italian cotton velvet jacket engineered for effortless drape and subtle shimmer under luxury gala lighting.",
    fabrics: ["Tuscan Cotton Velvet", "Duchess Satin"],
    atelierTime: "85 Hours Tailoring",
  },
];
