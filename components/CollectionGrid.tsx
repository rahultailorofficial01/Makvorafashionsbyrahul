...
export const COLLECTION_ITEMS: ProductItem[] = [
  ...
  {
    id: "MKV-003",
    title: "Royal Sherwanis Collection",
    ...
    description: "Imperial hand-embroidered groom sherwanis featuring Banarasi silk threads, Lucknowi chikankari patterns, and French silk-wool blends.",
    fabrics: ["Pure Banarasi Katan Silk", "Lucknowi Georgette Chikankari", "Silk-Wool Blend"],
